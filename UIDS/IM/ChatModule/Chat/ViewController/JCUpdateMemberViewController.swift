...
class JCUpdateMemberViewController: UIViewController {
    ...
    fileprivate func _reloadCollectionView() {
        ...
        case 0:
            ...
            tableView.frame = CGRect(x: tableView.mj_x, y: topOffset + 31, width: tableView.width, height: view.height - topOffset - 31)
        ...
        case 1:
            ...
            tableView.frame = CGRect(x: tableView.mj_x, y: topOffset + 55, width: tableView.width, height: view.height - topOffset - 55)
