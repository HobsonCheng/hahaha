...
class JCRemoveMemberViewController: UIViewController {
    ...
    fileprivate func _reloadCollectionView() {
        ...
        case 0:
            ...
            tableView.frame = CGRect(x: tableView.mj_x, y: 64 + 31, width: tableView.width, height: view.height - 64 - 31)
        case 1:
            ...
            tableView.frame = CGRect(x: tableView.mj_x, y: 64 + 55, width: tableView.width, height: view.height - 64 - 55)
        case 2:
