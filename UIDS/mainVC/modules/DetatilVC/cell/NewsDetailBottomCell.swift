...
class NewsDetailBottomCell: UITableViewCell {
    ...
    private func configureReplyCell() {
        ...
        iconImg.sd_setImage(with: URL(string: replyModel.icon), placeholderImage: UIImage(named: "comment_profile_mars.png"), options: SDWebImageOptions.avoidAutoSetImage, progress: nil, completed: nil)
    ...
    private func configureSameNewsCell() {
        newsIcon.sd_setImage(with: URL(string: sameNewsEntity.imgsrc), placeholderImage: UIImage(named: "303.png"), options: SDWebImageOptions.allowInvalidSSLCertificates, completed: nil)
